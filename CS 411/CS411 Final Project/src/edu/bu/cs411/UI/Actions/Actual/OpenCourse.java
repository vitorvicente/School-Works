...
/**
 * Open Course Action Class.
 *
 * @author vitor@bu.edu.
 * @version 1.0.0.
 */
public class OpenCourse extends GUIAction {
     ...
     */
    public OpenCourse() throws InstantiationException {
        super();
    }

    /**
     * Perform the Open Course Action by checking the validity of the Open Request, and working accordingly.
     * It includes logic to deal with errors inherent in the opening of a Course.
     * <p>
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (oldScreen instanceof CourseListScreen castedScreen) {
            ...
            selectedCourse.setStatus(CourseStatus.OPEN);
            newScreen = GUIScreen.goToOldScreen(oldScreen, GUIConfig.SUCCESSFULLY_OPEN_COURSE_MSG, this.getPageIndex());

            // Deals with Invalid Actions
        } else {
            newScreen = GUIScreen.goToOldScreen(oldScreen, GUIConfig.UNABLE_TO_OPEN_COURSE_MSG, this.getPageIndex());
        }
