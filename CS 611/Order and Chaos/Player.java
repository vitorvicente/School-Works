...
public class Player extends Entity {
	...
	public Player(int ID) {
		super(ID, "Player #" + ID, new ArrayList<Character>());
	...
	public Player(int ID, ArrayList<Character> pieces) {
		super(ID, "Player #" + ID, pieces);
		String name = this.getInitialName();
		this.setName(name);
	}

	public Player(int ID, String name, ArrayList<Character> pieces) {
		super(ID, name, pieces);
	}

	public Player(int ID, char[] pieces) {
		super(ID, "Player #" + ID, pieces);
		String name = this.getInitialName();
		this.setName(name);
	}

	public Player(int ID, String name, char[] pieces) {
		super(ID, name, pieces);
	}
