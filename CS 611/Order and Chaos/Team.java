...
public class Team extends Entity {
	...
	public Team(int ID) {
		super(ID, "Team #" + ID, new ArrayList<Character>());
		this.setMaxPlayersPerTeam(MAXMAX);
		this.createPlayers();
	}

	public Team(int ID, String name) {
		super(ID, name, new ArrayList<Character>());
		this.setMaxPlayersPerTeam(MAXMAX);
		this.createPlayers();
	}

	public Team(int ID, ArrayList<Character> pieces) {
		super(ID, "Team #" + ID, pieces);
		this.setMaxPlayersPerTeam(MAXMAX);
		this.createPlayers();
	}

	public Team(int ID, String name, ArrayList<Character> pieces) {
		super(ID, name, pieces);
		this.setMaxPlayersPerTeam(MAXMAX);
		this.createPlayers();
	}

	public Team(int ID, char[] pieces) {
		super(ID, "Team #" + ID, pieces);
		this.setMaxPlayersPerTeam(MAXMAX);
		this.createPlayers();
	}

	public Team(int ID, String name, char[] pieces) {
		super(ID, name, pieces);
		this.setMaxPlayersPerTeam(MAXMAX);
		this.createPlayers();
	}
	...
	public Team(int ID, ArrayList<Character> pieces, int maxPlayersPerTeam) {
		super(ID, "Team #" + ID, pieces);
		this.setMaxPlayersPerTeam(maxPlayersPerTeam);
		this.createPlayers();
	}

	public Team(int ID, String name, ArrayList<Character> pieces, int maxPlayersPerTeam) {
		super(ID, name, pieces);
		this.setMaxPlayersPerTeam(maxPlayersPerTeam);
		this.createPlayers();
	}

	public Team(int ID, char[] pieces, int maxPlayersPerTeam) {
		super(ID, "Team #" + ID, pieces);
		this.setMaxPlayersPerTeam(maxPlayersPerTeam);
		this.createPlayers();
	}

	public Team(int ID, String name, char[] pieces, int maxPlayersPerTeam) {
		super(ID, name, pieces);
		this.setMaxPlayersPerTeam(maxPlayersPerTeam);
		this.createPlayers();
	}
