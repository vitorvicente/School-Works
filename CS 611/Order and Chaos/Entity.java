...
public abstract class Entity implements Comparable<Entity> {
	 ...
	 * same thing, setID, setName, setPieces, resetStates (which basically sets all
	 ...
	 * "Entity #ID", Entities without a set list of available pieces get an empty
	 * one all Entities begin with zeroed out stats.
	 */
	public Entity(int ID) {
		this.setID(ID);
		this.setName("Entity #" + this.getID());
		this.setPieces(new ArrayList<Character>());
		this.resetStats();
	}
	...
	public Entity(int ID, String name, ArrayList<Character> pieces) {
		this.setID(ID);
		this.setName(name);
	...
	public Entity(int ID, String name, char[] pieces) {
		this.setID(ID);
		this.setName(name);
		this.setPieces(pieces);
		this.resetStats();
	...
	public Entity(int ID, ArrayList<Character> pieces) {
		this.setID(ID);
		this.setName("Entity #" + this.getID());
		this.setPieces(pieces);
		this.resetStats();
	...
	public Entity(int ID, char[] pieces) {
		this.setID(ID);
		this.setName("Entity #" + this.getID());
		this.setPieces(pieces);
		this.resetStats();
	...
	public ArrayList<Character> getPieces() {
		return this.pieces;
	}
	
	public void setPieces(ArrayList<Character> pieces) {
		this.pieces = pieces;
	}

	// Set Pieces method using an Array instead of an ArrayList
