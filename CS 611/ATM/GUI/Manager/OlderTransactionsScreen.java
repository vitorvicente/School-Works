...
public class OlderTransactionsScreen extends BankFrame {
	...
	public OlderTransactionsScreen(ArrayList<Client> clients, Manager manager) {
	...
	/*
	 * This method builds the actual Old Transactions Info GUI Screen with all its
	 * requirements.
	 */
	@Override
