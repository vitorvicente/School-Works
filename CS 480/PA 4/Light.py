...
class Light:
    ...
    def setSpotAngleLimit(self, spotAngleLimit):
        if type(spotAngleLimit) != (int) and type(spotAngleLimit) != (float):
    ...
    def toggleAmbient(self):
        ...
        print("ambient", self.ambientOn)

    def toggleDiffuse(self):
        self.diffuseOn = not self.diffuseOn
        print("diffuseOn", self.diffuseOn)

    def toggleSpecular(self):
        self.specularOn = not self.specularOn
        print("specularOn", self.specularOn)
