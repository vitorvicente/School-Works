...
from TriangleMaker import TriangleMaker
...
class Sketch(CanvasBase):
    ...
    * lineMaker: Line Maker Class Object, called whenever a Line needs to be drawn
    * triangleMaker: Triangle Maker Class Object, called whenever a Line needs to be drawn
    ...
    * buff_last: Buff. Last frame buffer
    ...
    def __init__(self, parent):
        ...
        self.triangleMaker = TriangleMaker(self.lineMaker)
    ...
    def Interrupt_MouseL(self, x, y):
        ...
        if len(self.points_l) % 2 == 1:
            ...
            PointMaker.drawPoint(self.buff, self.points_l[-1])
        elif len(self.points_l) % 2 == 0 and len(self.points_l) > 0:
            if self.debug > 0:
                print("draw a line from ", self.points_l[-2], " -> ", self.points_l[-1])
            self.lineMaker.drawLine(self.buff, self.points_l[-2], self.points_l[-1])
            self.points_l.clear()
    ...
    def Interrupt_MouseR(self, x, y):
        ...
        if len(self.points_r) % 3 == 1:
            ...
            PointMaker.drawPoint(self.buff, self.points_r[-1])
        elif len(self.points_r) % 3 == 2:
            if self.debug > 0:
                print("draw a line from ", self.points_r[-2], " -> ", self.points_r[-1])
            self.lineMaker.drawLine(self.buff, self.points_r[-2], self.points_r[-1])
            ...
            self.triangleMaker.drawTriangle(self.buff, self.points_r[-3], self.points_r[-2], self.points_r[-1])
            self.points_r.clear()
    ...
    def testCaseLine01(self, n_steps):
        ...
        for step in range(0, n_steps):
            ...
            self.lineMaker.drawLine(self.buff, v2, v0, doSmooth=True)
            self.lineMaker.drawLine(self.buff, v0, v1, doSmooth=True)
    ...
    def testCaseLine02(self, n_steps):
        ...
        for i in range(n_steps + 2):
            self.lineMaker.drawLine(self.buff,
        ...
        for i in range(n_steps + 1):
            ...
            self.lineMaker.drawLine(self.buff, v0, v1, doSmooth=True, doAA=self.doAA, doAAlevel=self.doAAlevel)
    ...
    def testCaseTri01(self, n_steps):
        ...
        for _ in range(n_steps):
            ...
            self.triangleMaker.drawTriangle(self.buff, v1, v0, v2, False, self.doAA, self.doAAlevel)
        ...
        for _ in range(n_steps):
            ...
            v2 = Point((int(cx + math.sin(theta + delta) * radius), int(cy + math.cos(theta + delta) * radius)),
                       ColorType((127. + 127. * math.sin(theta + delta)) / 255,
                                 (127. + 127. * math.sin(theta + delta + 2 * math.pi / 3)) / 255,
                                 (127. + 127. * math.sin(theta + delta + 4 * math.pi / 3)) / 255))
            self.triangleMaker.drawTriangle(self.buff, v0, v1, v2, True, self.doAA, self.doAAlevel)
    ...
    def testCaseTriTexture01(self, n_steps):
        ...
        for t in triangleList:
            self.triangleMaker.drawTriangle(self.buff, *t, doTexture=True)
